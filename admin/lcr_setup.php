...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("lcr_generateOneLcrPerPageWithAddress").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("lcr_useRestToPay").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("lcr_paiementMode").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';

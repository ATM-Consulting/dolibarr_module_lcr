...
/**
 * 	\defgroup   lcr     Module lcr
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/lcr/core/modules directory.
 *  \file       htdocs/lcr/core/modules/modlcr.class.php
 *  \ingroup    lcr
 *  \brief      Description and activation file for module lcr
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module lcr
 */
class modlcr extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->numero = 104940; // 104000 to 104999 for ATM CONSULTING
		...
		// for default path (eg: /lcr/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /lcr/core/modules/barcode)
		// for specific css file (eg: /lcr/css/lcr.css.php)
		...
		//							'css' => array('/lcr/css/lcr.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		// Config pages. Put here list of php page, stored into lcr/admin directory, to use to setup module.
		$this->config_page_url = array("lcr_setup.php@lcr");
        ...
        */
		...
		//							'position'=>100,
		//							'enabled'=>'$conf->lcr->enabled',	// Define condition to show or hide menu entry. Use '$conf->lcr->enabled' if entry must be visible if module is enabled.
	...
	function init($options='')
	{
		...
		dol_include_once('/lcr/script/create-maj-base.php');

		$result=$this->_load_tables('/lcr/sql/');
